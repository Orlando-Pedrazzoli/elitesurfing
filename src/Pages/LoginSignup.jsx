...
const LoginSignup = () => {
  return (
    <div className='min-h-screen flex items-center justify-center bg-white '>
      <div className='w-full max-w-md p-4 rounded-md shadow sm:p-8 bg-gray-900 dark:bg-white text-gray-100 dark:text-gray-800'>
        ...
        <div className='my-6 space-y-4'>
          <button
            ...
            type='button'
            className='flex items-center justify-center w-full p-4 space-x-4 border rounded-md focus:ring-2 focus:ring-offset-1 border-gray-400 dark:border-gray-600 focus:ring-red-400 focus:dark:ring-red-600'
          >
            <svg
